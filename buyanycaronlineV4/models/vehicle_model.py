...
class Vehicle(Advertisement):
    def __init__(self, adType: int = -1, owner: str = "", title: str = "", price: int = 0, decription: str = "",
        ...
        super().__init__(adType=adType,title=title, price=price, decription=decription, owner=owner, images=images)
        self.__make = make # TOYOTA
        self.__model = model # Land cruiser
        self.__features = features # [ # DVD, Bluetooth ... etc ]
        self.__color = color #FFFFF #
        self.__cylinders = cylinder #numbers
        self.__year = year
        self.__condition = condition # New / Used
        self.__fuelType = fuel # Oil / Ele / Hybrid / Desasil
        self.__warranty = warranty # Yes or No
...
class Car(Vehicle):
    def __init__(self, adType: int = -1, owner: str = "", title: str = "", price: int = 0, decription: str = "",
        ...
        self.__region = region # US / GCC
        self.__distance = distance
        self.__bodyType = body_type
        self.__numOfDoors = doors # numbers
        self.__transmission = trans # manual / Automatic
        self.__hp = hp # Numbers
...
class Boat(Vehicle):
    def __init__(self, adType: int = -1, owner: str = "", title: str = "", price: int = 0, decription: str = "",
        ...
        self.__type = typed # motor / sail ..etc
        self.__subType = sub_type # racing / finishing ..etc
        self.hours = hours
